document.addEventListener('DOMContentLoaded', () => {
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="profileModalLabel">Friend's Profile</h5>
    ...
    friendsSidebar.innerHTML = `
        ...
        <div class="input-group mt-3">
            <input type="text" id="newFriendInput" class="form-control" placeholder="Enter friend's name">
	...
	function displayWinLossData(winCount, lossCount) {
		...
		modalBody.innerHTML = `
			<p><strong>Wins:</strong> ${winCount} (${winPercentage}%)</p>
			<p><strong>Losses:</strong> ${lossCount} (${lossPercentage}%)</p>
		`;
	}
